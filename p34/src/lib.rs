...
impl From<BigUint4096> for String {
    fn from(value: BigUint4096) -> Self {
        ...
        let mut values = [0u8; 4096 / 8];
        let mut j = 0;
        let mut tmp_leg;
        for leg in value.values.iter() {
            tmp_leg = *leg;
            for _ in 0..8 {
                values[j] = (tmp_leg & 0xFF) as u8;
                tmp_leg >>= 8;
                j += 1;
            }
        }
...
mod tests {
    ...
    #[test]
    fn to_string_three_u64_digits() {
        let mut input = vec![0u64; 64];
        input[0] = 1;
        input[1] = 1;
        input[2] = 1;
        let input = BigUint4096::try_from(input).unwrap();
        let expected = "".to_string();
        assert_eq!(expected, String::from(input));
    }
